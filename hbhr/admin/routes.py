...
from hbhr import log, db, user_datastore
...
# @admin.route("/admin/setup")
# def setup():

#     chu = User.query.filter(User.username == 'vchu').first()
#     log.info(chu)
...
#     user_datastore.add_role_to_user(chu, admin_role)
#     log.info("added admin role to chu")

#     # user_datastore.activate_user(chu)

#     db.session.commit()
#     log.info("committed to db")

#     return render_template('admin/setup.html', title='Admin')
